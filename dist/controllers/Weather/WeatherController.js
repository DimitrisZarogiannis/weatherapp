...
var WeatherController = /** @class */ (function (_super) {
    ...
    function WeatherController(weather_service) {
        if (weather_service === void 0) { weather_service = new services_1.get_currentWeather(); }
        var _this = _super.call(this) || this;
        _this.weather_service = weather_service;
        return _this;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = res).json;
                        return [4 /*yield*/, this.weather_service.fetch_weather(req.query.city)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
